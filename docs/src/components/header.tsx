...
export function Header() {
  return (
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm dark:bg-neutral-950/90 border-b border-border">
      <div className="flex h-14 items-center justify-between px-4 gap-6">
        <div className="flex items-center gap-2">
          <Link className="flex items-center gap-2" href="/">
            <span className="inline-flex items-center justify-center w-7 h-7 rounded-md bg-primary text-primary-foreground text-xs font-mono font-bold">
              sk
            </span>
            <span className="font-mono font-semibold tracking-tight text-lg">sidekick</span>
          </Link>
        </div>
        <nav className="flex items-center gap-4">
          <a
            ...
            href="https://github.com/hesedcasa/sdkck"
          ...
          <a
            ...
            href="https://www.npmjs.com/package/sdkck"
            rel="noopener noreferrer"
            target="_blank"
          >
            npm
